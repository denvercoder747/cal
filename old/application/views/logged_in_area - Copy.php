...
<body onload="ref();">
	<h2>Welcome Back, <?php echo $this->session->userdata('username'); ?>!<?php echo $this->session->userdata('user_id'); ?></h2>
  ...
  <tr>
	...
	echo form_open("home/add_recipe", $attribute, $hidden); ?>
    ...
    <table width="100%" border="0">
      <tr>
        ...
        <table width="100%" border="0" cellspacing="2" cellpadding="2">
          ...
          <tr>
            <td><input type="submit" id="S1" name="S1" value="Submit" /></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td width="45%"><input type="file" name="fileField" id="fileField"></td>
        ...
        <td width="44%"><table width="100%" border="0" cellspacing="2" cellpadding="2">
          <tr>
            <td width="22%" align="center"><input name="rcp_weight" type="text" id="rcp_weight" size="10" onkeypress="calculate();"></td>
            <td width="18%" align="center"><input name="food_loss" type="text" id="food_loss" size="10" value="0" onkeypress="calculate();"></td>
            <td width="24%" align="center"><input name="finished_weight" type="text" id="finished_weight" size="10" readonly="readonly" onkeypress="calculate();"></td>
            <td width="21%" align="center"><input name="weight" type="text" id="weight" size="10" onkeypress="calculate();"></td>
            <td width="15%" align="center"><input name="per_pc_cost" type="text" id="per_pc_cost" size="10" readonly="readonly" onkeypress="calculate();"></td>
            </tr>
          <tr>
      ...
      <tr>
        <td colspan="2"><input name="tot_row" type="text" id="tot_row" value="0" >
            Total Quantity
