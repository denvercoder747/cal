    ...
    <div id="contentWrapper">
    	<div id="dashboard_style">
        	 <div id="siteLink"><span><a href="<?php echo base_url();?>index.php/site/dash_board">Dash Board</a></span>/ View All Recipe</div>
               ...
               <tr>
                 ...
                 <td width="82%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                   <tr class="recipe_header">
                     ...
                     <td width="68%" align="right"><div id="show"></div><?php echo $this->session->flashdata('message'); ?></td>
                   </tr>
                   <tr>
	...
	if(isset($records)) : foreach($records as $row) : ?>
                   <tr>
                     <td colspan="2"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="recipeTable">
                       <tr>
                         <td colspan="2" class="recipe_header_name"><?php echo anchor("site/view_recipe/$row->recipe_id", $row->name); ?></td>
                       </tr>
                       <tr>
