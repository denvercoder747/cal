...
<script language="javascript" type="text/javascript" src="<?php echo base_url();?>js/sprinkle.js"></script>
	...
	<script src="<?php echo base_url();?>js/scriptaculous.js?load=effects" type="text/javascript"></script>
