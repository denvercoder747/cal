...
<form action="<?php echo base_url() . 'search/'; ?>" method="post"><table width="100%" border="0" cellspacing="2" cellpadding="2">
  <tr>
    <td><input type="text" name="search" id="inputString1" maxlength="30" onkeyup="lookup(this.value,1);"  onblur="fill(this.value,1);">  
  ...
  <tr>
    <td><input type="text" name="search" id="inputString2" maxlength="30" onkeyup="lookup(this.value,2);"  onblur="fill(this.value,2);"> 
