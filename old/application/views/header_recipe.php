...
<link href="<?php echo base_url();?>css/tabMenu.css" type="text/css" rel="stylesheet" media="all" />
	<link rel="stylesheet" href="http://localhost/calcipe/css/lightbox.css" type="text/css" media="screen" />
	
	<script src="http://localhost/calcipe/js/prototype.js" type="text/javascript"></script>
	<script src="http://localhost/calcipe/js/scriptaculous.js?load=effects" type="text/javascript"></script>
	<script src="http://localhost/calcipe/js/lightbox.js" type="text/javascript"></script>
