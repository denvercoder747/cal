...
<div class="h1-edit"><span style="color:#CCE6E1;">Add Multi Recipe</span></div> 
      ...
      <tr>
        <td width="22%" height="24px" align="left" class=""><strong>Ingredients/Recipe</strong></td>
      ...
      <tr height="24px">
        ...
        <input class="calcipeMediumBox" autocomplete="OFF" type="text" name="ingRow[]" id="ingRow1" size="13"  onkeyup="lookup_multi(this.value,1);" />
        ...
        <tr height="24px">
          <td bgcolor="#FFFFFF" class=""><input type="checkbox" name="chk" id="chk2" style="display:none" />
            <input class="calcipeMediumBox" autocomplete="OFF" type="text" name="ingRow[]" id="ingRow2" size="13"  onkeyup="lookup_multi(this.value,2);" />
        ...
        <input class="calcipeMediumBox" autocomplete="OFF" type="text" name="ingRow[]" id="ingRow3" size="13"  onkeyup="lookup_multi(this.value,3);" />
...
<div style="height:25px; float:left; width:110px;"><img src="<?php echo base_url();?>images/addingredient.jpg" name="B1" id="B1" width="110" height="23" onClick="addIng_multi();calculate();" />
</div>
...
function conv()
{
	...
	document.getElementById('weight').value=calval;
        	  ...
        	  <table cellpadding="0" cellspacing="0" width="98%" bgcolor="#FFFFFF" height="320px" style="font-family:Arial, Helvetica, sans-serif; font-size:13px;">
...
<td height="25" bgcolor="#69b1c1"><table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td><input class="calcipeCal" name="food_loss" type="text" id="food_loss" value="<?php echo $food_loss;?>" size="2" onblur="calculate();" style="text-align:right; color:#000; font-weight:bold;"  /></td>
  </tr>
  <tr>
...
<td height="25" bgcolor="#92bec7"><table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td><input name="per_kg_cost" type="text" class="calcipeCal" id="per_kg_cost" style="text-align:right; color:#000; font-weight:bold;" size="10" readonly="readonly"  /></td>
...
<td height="25px" bgcolor="#9bc4c9"><table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td><input name="per_pc_cost" type="text" class="calcipeCal" id="per_pc_cost"  style="text-align:right; color:#000; font-weight:bold;" value="" size="2" readonly="readonly"  /></td>
    <td style="color:#000;"><?php if($currency=="INR"){?>
      <img src="<?php echo base_url();?>images/rupees-icon.png" width="10" height="10"/>
      <?php }else if($currency=="USD"){?>
      <img src="<?php echo base_url();?>images/dollar_icon.png" width="14" height="14"/>
