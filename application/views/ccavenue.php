...
<input type="hidden" name="billing_cust_name" value="<?php echo $first_name. " ".$last_name ;?>"> <!--Pass Customer Full Name -->
...
<input type="hidden" name="Merchant_Param" value="<?php $sess_id=$this->session->userdata('sess_id');?>">
