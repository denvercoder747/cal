...
<div id="content">
	...
	?>
		<h1>Send E-Mail(<?php echo $username;?>)</h1>
	</div>
	<!-- end page-heading -->
	...
	<tr>
		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<!--  end message-green -->
             <form name="profile" id="profile" action="../send_mail" method="post" >
    <input type="hidden" name="UserId" id="UserId" value="<?php echo $this->uri->segment(3);?>"  />
		...
		<tr>
			<th valign="top">Message To:</th>
			<td><input type="text" name="msgto" value="<?php echo $username;?>" readonly="readonly" class="inp-form" />
			  </select></td>
			<td></td>
		</tr>
		<tr>
