...
<div id="login-holder">
	...
	<!-- start logo -->
	<div id="logo-login">
		<a href="/index.php"><img src="/images/cal_logo.png" width="156" height="40" alt="" /></a>
	</div>
	<!-- end logo -->
   ...
   <?php 
		$attribute = array ("id" => "admin_login","name" => "admin_login");
		$hidden = array("Parent_id"=>"0");
	 ?>
<?php echo form_open("admin/validate_credentials", $attribute, $hidden); ?>
		...
		<tr>
			<th></th>
			<td><input type="button" class="submit-login" onclick="return validate_login();"  /></td>
		</tr>
		</table>
      <?php echo form_close(); ?>   
	</div>
