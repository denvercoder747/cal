...
$Redirect_Url ="http://www.calcipe.com/index.php/member/confirm_reniew";
...
<input type="hidden" name="reniew_level" value="<?php echo $reniew_level;?>">
<input type="hidden" name="username" value="<?php echo $username; ?>">
<input type="hidden" name="reniew_amt_inr" value="<?php echo $reniew_amt_inr;?>">
