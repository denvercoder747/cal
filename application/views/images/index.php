...
<head>
    <title>Recipe Image Gallery</title>
    <style type="text/css">
/*    *, body {
        font-family: "Arial";
    }
...
<div id="container">
    ...
    <div id="imglist">
        <form enctype="multipart/form-data" id="fupload" method="post" action="<?php echo site_url('site/more_image/'.$this->uri->segment(3, 0)); ?>">
            <input name="userfile" type="file" size="20"/>
            <input type="hidden" name="rcpId" id="rcpId" value="<?php echo $this->uri->segment(3);?>"  />
