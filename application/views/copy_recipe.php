...
<input type="image" src="/images/save-recipe.jpg" id="S1" name="S1" value="Save Recipe"  />
        ...
        <div id="add_recipe_right_part">
        	<div id="portion_size">
        	  <table cellpadding="0" cellspacing="0" width="98%" bgcolor="#FFFFFF" height="350px" style="font-family:Arial, Helvetica, sans-serif; font-size:13px;">
...
<td height="25" bgcolor="#69b1c1"><table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td><input class="calcipeCal" name="food_loss" type="text" id="food_loss" value="<?php echo $row->food_loss; ?>" size="2" onblur="calculate();" style="text-align:right; color:#000; font-weight:bold;"  /></td>
  </tr>
  <tr>
...
<td height="25px" bgcolor="#9bc4c9"><table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td><input name="per_pc_cost" type="text" class="calcipeCal" id="per_pc_cost"  style="text-align:right; color:#000; font-weight:bold;" value="<?php echo $row->cost_per_piece; ?>" size="2" readonly="readonly"  /></td>
    <td style="color:#000;"><?php if($currency=="INR"){?>
      <img src="<?php echo base_url();?>images/rupees-icon.png" width="10" height="10"/>
      <?php }else if($currency=="USD"){?>
      <img src="<?php echo base_url();?>images/dollar_icon.png" width="14" height="14"/>
