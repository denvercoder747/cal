...
<?php if(isset($records)) : foreach($records as $row) : ?>     
         <div id="siteLink"><span><a href="<?php echo base_url();?>index.php/site/dash_board">Dash Board</a></span>/<span><a href="<?php echo base_url();?>index.php/site/recipe">View Recipes</a></span>/ Copy Recipe/ </div>
...
<table width="100%" border="0" align="right" cellpadding="0" cellspacing="0" class="innerTable">
    	        <tr>
    	          <td width="100%" class="recipe_header">Copy Recipe Informations
                    <script>
function ref()
{
var cnt =<?php echo $row->progress_value-20; ?>;//Get the values in the textarea
...
var value= (main / max_numb_of_words);//Divide it by the Max numb of words previously declared
	...
	"width": value+'%',
				...
				else
				{
                    ...
                    <input type="hidden" id="progress_val" name="progress_val"  /><?php //print_r($_POST);?>
                  </td>
  	          </tr>
    	        <tr>
    	          <td height="5"></td>
    	                ...
    	                <table width="100%" border="0" align="right" cellpadding="0" cellspacing="0" >
    	                  <tr>
    	                    <td width="50%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
    	                      ...
    	                      <tr>
    	                        <td><input type="hidden" id="T3" name="T3" size="20" value="<?php echo $row->image;?>" />
    	                          <?php if($row->image != "") { ?>
    	                          <br />
    	                      ...
    	                      <tr>
    	                        <td>Recipe Name :</td>
    	                        <td><input name="recipe_name" type="text" id="recipe_name" value="" size="30" /></td>
  	                        </tr>
    	                      <tr>
    	                    ...
    	                    <td width="46%" align="right" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
    	                      <tr>
    	                        ...
    	                        <td width="35%"><input name="rcp_weight" type="text" id="rcp_weight" size="10" readonly="readonly" value="<?php echo $row->weight; ?>" /></td>
    	                        <td width="30%">&nbsp;</td>
  	                        </tr>
    	                      ...
    	                      <tr>
    	                        <td>Profit %</td>
    	                        <td><input name="profit" type="text" id="profit" value="<?php echo $row->profit; ?>" size="10" onblur="calculate();" /></td>
    	                        <td>&nbsp;</td>
  	                        </tr>
    	                      <tr>
    	                        <td>Selling Price</td>
				...
				foreach($this->membership_model->get_gradients($row->recipe_id) as $grad){ ?>
    	                        <tr>
    	                          ...
    	                          <td align="center" valign="middle"><img src="<?php echo base_url();?>images/minus_image.png" width="14" height="14" onclick="if(confirm('Are you sure you want to Remove'))removeRowFromTable(<?php echo $incr;?>);hideMsg2();calculate();"/>
...
function newPopup(url) {
	popupWindow = window.open(
		url,'popUpWindow','height=700,width=800,left=10,top=10,resizable=yes,scrollbars=yes,menubar=no,location=no,directories=no,status=yes')
    	                      ...
    	                      <img src="<?php echo base_url();?>images/addmore.png" name="B1" id="B1" width="91" height="23" onclick="addIng();calculate();" /></td>
  	                    </tr>
    	                  <tr>
