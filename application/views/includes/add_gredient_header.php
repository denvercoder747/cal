            <div id="allHeader">
                    ...
                    <div id="header_css">
                   			<!-- <img src="/images/ingredient_latest.png" width="372" height="57" />-->
                    </div>
                   <!-- <div id="loggedUser">
                ...
                <div class="art-nav">
                	...
                	<ul class="art-menu">
                		...
                		<li><a href="<?php echo base_url();?>index.php/gredient/" class=" active"><span class="l"></span><span class="r"></span><span class="t">Ingredients</span></a></li>
