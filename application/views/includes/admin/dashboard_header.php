...
<div class="nav-outer"> 
		...
		<ul class="current"><li><a href="<?php echo base_url();?>index.php/admin/dash_board"><b>Dashboard</b></a><!--[if IE 7]><!--><!--<![endif]-->
		...
		<div class="select_sub">
			<ul class="sub">
				<li><a href="<?php echo base_url();?>index.php/admin/allUser">View all users</a></li>
				<li><a href="#nogo">Add User</a></li>
				<li><a href="<?php echo base_url();?>index.php/admin/delUser">Delete Users</a></li>
			</ul>
		</div>
		<!--[if lte IE 6]></td></tr></table></a><![endif]-->
		</li>
		...
		<div class="select_sub">
			<ul class="sub">
				<li><a href="<?php echo base_url();?>index.php/admin/viewPlans">View Plans</a></li>
