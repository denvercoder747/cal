...
//  					$("#cart_content").html(cart);
  					$("#display").html(cart);
  					$("#message_new").html('Ingredient Added Successfully');
				});
...
function Checkfiles()
{
var fup = document.getElementById('gredient_file');
...
<div class="container">
    <ul class="ingredientTabMenus">
        ...
        <li><a href="#tab2">Upload Ingredient Excel(.csv/.xls)</a></li>
...
<div id="message_new"><?php //print_r($this->session);print_r($_SESSION);//
  ...
  <table width="100%" border="0">
    <tr style="background-color:#E6EEEE;">
      <th width="12%" height="20" style="font-size:10px;">Ingredient Name</th>
      <th width="15%" align="right" style="font-size:10px;">Quantity</th>
      <th width="11%" align="center" style="font-size:10px;">Measure</th>
      <th width="15%" align="right" style="font-size:10px;">Rate</th>
      <th width="14%" align="right" style="font-size:10px;">Amount Per KG</th>
      <th width="14%" align="center" style="font-size:10px;">Purchased From</th>
      <th width="7%" align="center" style="font-size:10px;">Brand</th>
      <th align="center" style="font-size:10px;">Contact</th>
      <th align="center" style="font-size:10px;">&nbsp;</th>
      </tr>
    <tr>
      <td align="center"><input type="text" name="ingRow" id="ingRow" size="20" value="" style="width:110px;"   /><span id="ingRowInfo"></span></td>
      <td align="right"><input type="text" style="text-align:right;" name="qtyRow" id="qtyRow" class="calcipeAmountBox"  value="0"  onkeyup="calc();"/><span id="qtyRowInfo"></span></td>
      <td align="center">
      ...
      <td align="right"><input type="text" style="text-align:right;" name="rateRow" id="rateRow" class="calcipeAmountBox"  value="0" onkeyup="calc();" /><span id="rateRowInfo"></span></td>
      <td align="right"><input type="text" style="text-align:right;" name="amtKg" id="amtKg" class="calcipeAmountBox" size="5" value="0" readonly="readonly"  /></td>
      <td align="center"><input name="purFrom" type="text" class="calcipeAmountBox" id="purFrom" value="" size="10" maxlength="15"  /></td>
      <td align="center"><input name="brand" type="text" class="calcipeAmountBox" id="brand" value="" size="10" maxlength="15"  /></td>
      <td width="7%" align="center"><input name="contact" type="text" class="calcipeAmountBox" id="contact" value="" size="10" maxlength="15" /></td>
      <td width="5%" align="center"><span class="comment_box" style="padding:6px; padding-left:10px;position:relative;top:7px;">
  ...
  <?php echo form_close(); ?>
        ...
        <form name="import_form" method="post" action="/index.php/gredient/export_ex1" enctype="multipart/form-data" onsubmit="return Checkfiles();">
           <input type="file" name="gredient_file" id="gredient_file"  />
        <input type="submit" class="calcipeButton" name="E1" id="E1" value="Submit"  />
        &nbsp;&nbsp;(<a href="/sampletables.xls">Download Sample Formats(.xls)</a>)
        </form>
        </div>  
