...
<div id="content">
	...
	<tr>
		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<!--  end message-green -->
             <form name="profile" id="profile" action="<?php echo base_url();?>index.php/admin/add_message" enctype="multipart/form-data" method="post" >
    <input type="hidden" name="UserId" id="UserId" value="<?php echo $this->uri->segment(3);?>"  />
		<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
		<tr>
		  <th valign="top">Message Title:</th>
		  <td><input type="text" name="msgtitle" class="inp-form" /></td>
		  <td></td>
		  </tr>
		<tr>
			...
			<td><select name="msgType"  class="styledselect_form_1">
			  ...
			  <option value="Embed Video">Embed Video</option>
			  </select></td>
			<td></td>
		</tr>
		<tr>
	...
	<div class="bubble-right"></div>
		...
		<tr>
		  ...
		  <td><textarea name="textMessage" cols="" rows="" class="form-textarea"></textarea></td>
	  ...
	  <td></td>
             ...
             <!--  start product-table ..................................................................................... -->
				...
				<tr <?php echo $classrpw;?>>
					...
					<a href="/index.php/admin/delete_message/<?php echo $row->id_message;?>" title="Delete" onClick=" return confirm('Are you sure you want to '+ 'delete the record for'+ '<?php echo addslashes($row->message_title);?>'+'?')"class="icon-2 info-tooltip"></a>
					<a href="<?php echo base_url();?>index.php/admin/edit_messageboard/<?php echo $row->id_message; ?>" title="Edit" class="icon-3 info-tooltip"></a></td>
				</tr>
						<?php $i++;endforeach; ?>
						<?php else : ?>	
                    <tr >
