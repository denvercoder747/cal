...
<link href="http://cdn.webrupee.com/font" type="text/css" rel="stylesheet" media="all" />
...
<div class="content-main">
		  ...
		  <form name="signup" id="signup" action="<?php echo base_url();?>index.php/home/create_member" method="post" enctype="multipart/form-data" class="standardForm">
				...
				<tr>
					<td>
						<table class="standardChooseLevel" align="center" border="0" cellpadding="2" cellspacing="2">
									...
									<th>Silver</th>
									<td>
										<span class="WebRupee">Rs.</span>99.00 per month									</td>
									<th class="radioChooseLevel">
									...
									<th>Gold</th>
									<td>
										<span class="WebRupee">&#x20B9;</span>199.00 per month									</td>
									<th class="radioChooseLevel">
									...
									<th>Diamond</th>
									<td>
										<span class="WebRupee">&#x20B9;</span>299.00 per month									</td>
									<th class="radioChooseLevel">
...
<table id="contact_info" class="standard-table standard-table-dash standardSIGNUPTable noBdTop nomargin" border="0" cellpadding="2" cellspacing="0">
	...
	<tr>
	  <th>* Profit Amount(%):</th>
	  <td><input name="profit" id="profit" type="text" value="300"></td>
	  </tr>
	<tr>
	  <th>Photo</th>
