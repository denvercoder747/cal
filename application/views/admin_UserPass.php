...
function validate()
{
	...
	var repassword=document.getElementById('re_password').value
		...
		document.getElementById('new_password').className='inp-form'
		document.getElementById('re_password').className='inp-form'
		
	if(password=="")
	{
		document.getElementById('newpass').style.display='block';
		document.getElementById('new_password').className='inp-form-error'
		return false;
	}
	if(repassword=="")
	{
		document.getElementById('repass').style.display='block';
		document.getElementById('re_password').className='inp-form-error'
		return false;
	}
...
<div id="content">
	...
	<!--  start page-heading -->
	<div id="page-heading">
		<h1>Edit Password (<?php echo $username;?>)</h1>
	</div>
	<!-- end page-heading -->
	...
	<td>
		...
		<!-- start id-form -->
             ...
             <form name="profile" id="profile" action="../update_password" method="post" class="standardForm" onsubmit="return validate();">
    <input type="hidden" name="UserId" id="UserId" value="<?php echo $this->uri->segment(3); ?>"  />
		<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
		<tr>
			<th valign="top">New Password</th>
			<td><input name="new_password" type="password" class="inp-form" id="new_password" value="" /></td>
			<td><div id="newpass" style="display:none"><div class="error-left"></div>
			<div class="error-inner">This field is required.</div></div></td>
		</tr>
		<tr>
			<th valign="top">Re-type Password</th>

			<td><input name="re_password" type="password" class="inp-form" id="re_password" value="" /></td>
			<td><div id="repass" style="display:none"><div class="error-left"></div>
