...
<div class="container">
    <ul class="ingredientTabMenus">
        <li><a href="#tab1">Add New Ingredients</a></li>
        <li><a href="#tab2">Import Ingredients(.xls)</a></li>
    </ul>
...
<div id="message"><?php //print_r($this->session);print_r($_SESSION);//
  ...
  <?php echo form_open('gredient/edit_gredient'); ?>
...
//				print_r($records);
  ...
  <table width="100%" border="0">
    ...
    <tr>
      <td><input type="text" name="ingRow" id="ingRow" size="20" value="<?php echo $grad->name; ?>"   /><span id="ingRowInfo"></span></td>
      <td><input type="text" name="qtyRow" id="qtyRow" size="5" value="<?php echo $grad->quantity; ?>"  onkeyup="calc();"/><span id="qtyRowInfo"></span></td>
      <td>
      ...
      <td><input type="text" name="rateRow" id="rateRow" size="5" value="<?php echo $grad->price; ?>" onkeyup="calc();" /><span id="rateRowInfo"></span></td>
      <td><input type="text" name="amtKg" id="amtKg" size="5" value="<?php echo $grad->amount_kg; ?>" readonly="readonly"  /></td>
      <td><input type="text" name="purFrom" id="purFrom" size="10" value="<?php echo $grad->purchased_from; ?>"  /></td>
      <td><input type="text" name="brand" id="brand" size="10" value="<?php echo $grad->brand; ?>"  /></td>
      <td><input type="text" name="contact" id="contact" size="10" value="<?php echo $grad->contact; ?>"  /></td>
      <td><span class="comment_box" style="padding:4px; padding-left:10px;"><input type="hidden" name="ingId" id="ingId" value="<?php echo $id; ?>"  />
        <input type="submit"  value="Update"  id="UpdateG" name="Button" class="comment_button"/>
      </span></td>
      </tr>
    </table>
          <?php }?>
